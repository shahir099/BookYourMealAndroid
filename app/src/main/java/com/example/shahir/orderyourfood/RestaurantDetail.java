...
public class RestaurantDetail extends AppCompatActivity implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookTable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RestaurantDetail.this,TestFoodDetail.class);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(RestaurantDetail.this,"Added to Cart",Toast.LENGTH_SHORT).show();
                //Intent calender=new Intent(RestaurantDetail.this,CalendarActivity.class);
        ...
        ratingTbl.child(Common.currentUser.getPhone()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                else
                {
                    // Update new Value
                    ratingTbl.child(Common.currentUser.getPhone()).setValue(rating);
                    Toast.makeText(RestaurantDetail.this,"Thanks For Your Collaboration !",Toast.LENGTH_SHORT).show();
